...
export const systemConfigRouteOptions: PermissionRequirement[] = [
  ...
  view('sistema-config-regimes-tributarios'),
  view('sistema-config-recalculo-tributario'),
  view('sistema-config-comercial-tipos'),
  view('sistema-config-setores'),
  view('sistema-config-nfse-emissao'),
  view('sistema-config-formas-recebimento'),
  view('sistema-config-tipos-remuneracao'),
  view('sistema-config-tipos-sistemas'),
]
