...
export default async function RegrasFisicoPage() {
  const permissions = await getCurrentUserEffectivePermissions()
  if (!hasPermission(permissions, 'agente-corban-regras-fisico', 'can_view')) {
    redirect('/acesso-negado')
  }

  const resource = 'agente-corban-regras-fisico' as const
