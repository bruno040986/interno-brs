...
import { getWhatsappTemplates, saveWhatsappTemplate } from '../../actions'
import { MessageSquare, Plus, Edit2, Save, Loader2, Tag, CheckCircle, AlertCircle } from 'lucide-react'
...
export default function WhatsappTemplatesPage() {
  ...
  async function loadData() {
    ...
    if (res.success && res.templates) {
      ...
      setSelectedItem((res.templates as any[])[0] || null)
    } else {
  ...
  function handleNew() {
    setSelectedItem({ name: 'Novo Modelo de WhatsApp', body: '' })
  }
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '0.7fr 0.3fr', gap: '1rem', flex: 1, minHeight: 0 }}>
              <div className="form-group" style={{ display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                ...
                <div style={{ marginTop: '0.35rem', fontSize: '0.75rem', color: 'var(--brs-gray-400)' }}>
                  Observação: WhatsApp não suporta todo tipo de formatação. Use texto simples.
                </div>
              </div>
